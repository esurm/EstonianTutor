            ...
            return (
              <Button
                ...
                className={`
                  ...
                  ${mode.id === 'quiz-vocabulary' ? 'bg-blue-50 border-blue-200 hover:bg-blue-100 hover:border-blue-300' : 
                    mode.id === 'quiz-grammar' ? 'bg-indigo-50 border-indigo-200 hover:bg-indigo-100 hover:border-indigo-300' :
                    mode.id === 'quiz-conjugation' ? 'bg-emerald-50 border-emerald-200 hover:bg-emerald-100 hover:border-emerald-300' :
